module.exports = [
"[project]/lib/scheduleGenerator.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getWeekendsInCycle(cycleYear) {
    const weekends = [];
    const holidaySet = new Set((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$holidayUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getHolidaysForCycle"])(cycleYear).map((h)=>h.date));
    const cycleMonths = [
        {
            y: cycleYear,
            m: 2
...
function generateSchedule(cycleYear, existingShifts = {}) {
    ...
    // ─── 1. HOLIDAYS ───────────────────────────────────────────────────────────
    const blocks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$holidayUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getHolidayBlocksForCycle"])(cycleYear);
...
//# sourceMappingURL=lib_scheduleGenerator_ts_ea86dbaf._.js.map